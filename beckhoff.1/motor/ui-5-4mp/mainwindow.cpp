 ...
 *---------------------------------------------------------------------------*/
  ...
  QString pmac,nmac,a1mac,d1mac,macm1,macm2,macm3,macm4,macch;
  if(pm){
    macro.append(pm);
    macch.append("C1");
    ...
    pmac.append("P=CHA");
    nmac.append("N=4m");
    a1mac.append("A1=3162");
    d1mac.append("D1=4002");
    macm1.append("M1=2531-1");
    macm2.append("M2=2531-2");
    macm3.append("M3=2531-3");
    macm4.append("M4=2541-4");
  }
  ...
  _mac1234.append(macm4).append(",").append(a1mac).append(",");
  _mac1234.append(d1mac).append(",").append(nmac).append(",");
