...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        qeformM1->setGeometry(QRect(8, 36, 159, 187));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        qeformM1->setProperty("variableSubstitutions", QVariant(QApplication::translate("MainWindow", "M=$(M1),A=$(A1),C=$(C1)", 0)));
