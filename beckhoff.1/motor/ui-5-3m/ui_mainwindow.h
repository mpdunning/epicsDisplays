...
public:
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        qeformM1->setProperty("variableSubstitutions", QVariant(QApplication::translate("MainWindow", "P=$(P),M=$(M1),N=$(N),R=$(A1),C=1", 0)));
        qeformM2->setProperty("uiFile", QVariant(QApplication::translate("MainWindow", "/afs/slac/g/testfac/tools/display/beckhoff.1/common/ui/motormove.ui", 0)));
        qeformM2->setProperty("variableSubstitutions", QVariant(QApplication::translate("MainWindow", "P=$(P),M=$(M2),N=$(N),R=$(A1),C=2", 0)));
        qeformM3->setProperty("uiFile", QVariant(QApplication::translate("MainWindow", "/afs/slac/g/testfac/tools/display/beckhoff.1/common/ui/motormove.ui", 0)));
        qeformM3->setProperty("variableSubstitutions", QVariant(QApplication::translate("MainWindow", "P=$(P),M=$(M3),N=$(N),R=$(A2),C=1", 0)));
