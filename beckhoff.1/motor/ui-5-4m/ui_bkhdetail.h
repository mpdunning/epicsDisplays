...
public:
    ...
    void retranslateUi(QDialog *BkhDetail)
    {
        ...
        qeform_18->setProperty("variableSubstitutions", QVariant(QApplication::translate("BkhDetail", "M=$(M4),N=$(N)", 0)));
        tabWidget_2->setTabText(tabWidget_2->indexOf(tab_2), QApplication::translate("BkhDetail", "Mot 4", 0));
