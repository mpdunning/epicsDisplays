...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        qeformM1->setGeometry(QRect(8, 36, 159, 172));
        qeformM2 = new QEForm(centralwidget);
        qeformM2->setObjectName(QStringLiteral("qeformM2"));
        qeformM2->setGeometry(QRect(174, 36, 159, 172));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        qeformM1->setProperty("variableSubstitutions", QVariant(QApplication::translate("MainWindow", "M=$(M1)", 0)));
        ...
        qeformM2->setProperty("variableSubstitutions", QVariant(QApplication::translate("MainWindow", "M=$(M2)", 0)));
