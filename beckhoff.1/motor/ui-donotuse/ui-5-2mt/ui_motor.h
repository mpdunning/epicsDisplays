...
public:
    ...
    void setupUi(QDialog *Motor)
    {
        ...
        qelabel_3->setGeometry(QRect(56, 60, 89, 16));
        ...
        qeshape_9->setGeometry(QRect(130, 104, 10, 17));
        ...
        qeshape_4->setGeometry(QRect(30, 104, 100, 17));
        ...
        qeshape_2->setGeometry(QRect(30, 114, 100, 4));
        qeshape_2->setProperty("scale1", QVariant(0.0067));
        qeshape_2->setProperty("offset1", QVariant(0));
        qeshape_2->setProperty("point2", QVariant(QPoint(100, 4)));
        ...
        qeshape->setGeometry(QRect(30, 108, 100, 4));
        qeshape->setProperty("animation1", QVariant(QEShape::Width));
        qeshape->setProperty("scale1", QVariant(0.0067));
        qeshape->setProperty("offset1", QVariant(0));
        qeshape->setProperty("point2", QVariant(QPoint(100, 4)));
        ...
        qeshape_3->setGeometry(QRect(20, 104, 10, 17));
        ...
        qelabel_4->setGeometry(QRect(42, 78, 77, 20));
        QFont font;
        ...
        frame->setGeometry(QRect(4, 4, 159, 32));
        ...
        GO_PB->setGeometry(QRect(122, 126, 32, 20));
        ...
        FOR_PB->setGeometry(QRect(130, 150, 24, 20));
        QFont font2;
        ...
        REV_PB->setGeometry(QRect(30, 150, 24, 20));
        ...
        STOP_PB->setGeometry(QRect(70, 172, 49, 20));
        ...
        DenyRVQELB->setGeometry(QRect(44, 176, 19, 15));
        ...
        DenyFOQELB->setGeometry(QRect(126, 176, 21, 15));
    ...
    void retranslateUi(QDialog *Motor)
    {
        ...
        qelabel_3->setProperty("variable", QVariant(QApplication::translate("Motor", "$(P):CALC:$(M)-$(N):POS:MM", 0)));
        qelabel_3->setProperty("variableSubstitutions", QVariant(QApplication::translate("Motor", "P=CHA,M=2531-1,N=2", 0)));
        qeshape_9->setProperty("variable1", QVariant(QApplication::translate("Motor", "$(P):BI:$(M)-$(N):LIM:FOR", 0)));
        qeshape_9->setProperty("variableSubstitutions", QVariant(QApplication::translate("Motor", "P=CHA,M=2531-1,N=2", 0)));
        qeshape_2->setProperty("variable1", QVariant(QApplication::translate("Motor", "$(P):AO:$(M)-$(N):SET:POS:MM", 0)));
        qeshape_2->setProperty("variableSubstitutions", QVariant(QApplication::translate("Motor", "P=CHA,M=2531-1,N=2", 0)));
        qeshape->setProperty("variable1", QVariant(QApplication::translate("Motor", "$(P):CALC:$(M)-$(N):POS:MM", 0)));
        qeshape->setProperty("variable2", QVariant(QString()));
        qeshape->setProperty("variableSubstitutions", QVariant(QApplication::translate("Motor", "P=CHA,M=2531-1,N=2", 0)));
        qeshape_3->setProperty("variable1", QVariant(QApplication::translate("Motor", "$(P):BI:$(M)-$(N):LIM:REV", 0)));
        qeshape_3->setProperty("variableSubstitutions", QVariant(QApplication::translate("Motor", "P=CHA,M=2531-1,N=2", 0)));
        qelabel_4->setProperty("variable", QVariant(QApplication::translate("Motor", "$(P):MBBI:$(M)-$(N):MOTOR:STATE", 0)));
        qelabel_4->setProperty("variableSubstitutions", QVariant(QApplication::translate("Motor", "P=CHA,M=2531-1,N=2", 0)));
        qelabel->setProperty("variable", QVariant(QApplication::translate("Motor", "$(P):LI:$(M)-$(N):DATA.DESC", 0)));
        qelabel->setProperty("variableSubstitutions", QVariant(QApplication::translate("Motor", "P=CHA,M=2531-1,N=2", 0)));
        ...
        qelineedit->setText(QApplication::translate("Motor", "10.00 mm", 0));
        qelineedit->setProperty("variable", QVariant(QApplication::translate("Motor", "$(P):AO:$(M)-$(N):SET:POS:ABS", 0)));
        qelineedit->setProperty("variableSubstitutions", QVariant(QApplication::translate("Motor", "P=CHA,M=2531-1,N=2", 0)));
        qelineedit_2->setProperty("variable", QVariant(QApplication::translate("Motor", "$(P):AO:$(M)-$(N):SET:INC:MM", 0)));
        qelineedit_2->setProperty("variableSubstitutions", QVariant(QApplication::translate("Motor", "P=CHA,M=2531-1,N=2", 0)));
        label_3->setText(QApplication::translate("Motor", "Abs", 0));
        label_4->setText(QApplication::translate("Motor", "Rel", 0));
        DenyGOQELB->setProperty("variable", QVariant(QApplication::translate("Motor", "$(P):BI:$(M)-$(N):DENYGO", 0)));
        DenyGOQELB->setProperty("variableSubstitutions", QVariant(QApplication::translate("Motor", "P=CHA,M=2531-1,N=2", 0)));
        ...
        GO_PB->setProperty("variable", QVariant(QApplication::translate("Motor", "$(P):BO:$(M)-$(N):GO:POS", 0)));
        GO_PB->setProperty("variableSubstitutions", QVariant(QApplication::translate("Motor", "P=CHA,M=2531-1,N=2", 0)));
        ...
        FOR_PB->setProperty("variable", QVariant(QApplication::translate("Motor", "$(P):BO:$(M)-$(N):JOG:FOR", 0)));
        FOR_PB->setProperty("variableSubstitutions", QVariant(QApplication::translate("Motor", "P=CHA,M=2531-1,N=2", 0)));
        ...
        REV_PB->setProperty("variable", QVariant(QApplication::translate("Motor", "$(P):BO:$(M)-$(N):JOG:REV", 0)));
        REV_PB->setProperty("variableSubstitutions", QVariant(QApplication::translate("Motor", "P=CHA,M=2531-1,N=2", 0)));
        ...
        STOP_PB->setProperty("variable", QVariant(QApplication::translate("Motor", "$(P):BO:$(M)-$(N):STOP", 0)));
        STOP_PB->setProperty("variableSubstitutions", QVariant(QApplication::translate("Motor", "P=CHA,M=2531-1,N=2", 0)));
        DenyRVQELB->setProperty("variable", QVariant(QApplication::translate("Motor", "$(P):BI:$(M)-$(N):DENYRV", 0)));
        DenyRVQELB->setProperty("variableSubstitutions", QVariant(QApplication::translate("Motor", "P=CHA,M=2531-1,N=2", 0)));
        DenyFOQELB->setProperty("variable", QVariant(QApplication::translate("Motor", "$(P):BI:$(M)-$(N):DENYFO", 0)));
        DenyFOQELB->setProperty("variableSubstitutions", QVariant(QApplication::translate("Motor", "P=CHA,M=2531-1,N=2", 0)));
    } // retranslateUi
