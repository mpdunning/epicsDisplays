...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Feature_t, stringdata) + ofs \
...
void Feature::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Feature::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Feature::closing)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Feature::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Feature.data,
...
void *Feature::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::Feature"))
        return static_cast< Ui::Feature*>(const_cast< Feature*>(this));
