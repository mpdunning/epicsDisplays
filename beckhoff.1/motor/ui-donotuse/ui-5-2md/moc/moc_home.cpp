...
void Home::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Home::closing)) {
                *result = 0;
            }
        }
    }
...
void *Home::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::HomeSA"))
        return static_cast< Ui::HomeSA*>(const_cast< Home*>(this));
