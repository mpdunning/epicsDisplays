/********************************************************************************
** Form generated from reading UI file 'controlsa.ui'
**
...
#ifndef UI_CONTROLSA_H
#define UI_CONTROLSA_H
...
public:
    ...
    void retranslateUi(QDialog *Control)
    {
        ...
        qelabel->setProperty("variable", QVariant(QApplication::translate("Control", "$(P):LI:$(M)-$(N):DATA.DESC", 0)));
        qelabel->setProperty("variableSubstitutions", QVariant(QApplication::translate("Control", "P=CHA,M=2531-1,N=2", 0)));
        ...
        qeform->setProperty("uiFile", QVariant(QApplication::translate("Control", "/afs/slac/g/testfac/tools/display/beckhoff/common/ui/control.ui", 0)));
    } // retranslateUi
