 ...
 *---------------------------------------------------------------------------*/
  ...
  QString str,pmac,nmac,a1mac,a2mac;
  ...
  _macadc1.append(pmac).append(",").append(a1mac).append(",").append(nmac);
  _macadc1=_macadc1.replace("A1","A");
  _macadc2.append(pmac).append(",").append(a2mac).append(",").append(nmac);
  _macadc2=_macadc2.replace("A2","A");
