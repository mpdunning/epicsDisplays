...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        qeformM1->setGeometry(QRect(8, 38, 163, 187));
        qeformM2 = new QEForm(centralwidget);
        qeformM2->setObjectName(QStringLiteral("qeformM2"));
        qeformM2->setGeometry(QRect(176, 38, 163, 187));
        qeformM3 = new QEForm(centralwidget);
        qeformM3->setObjectName(QStringLiteral("qeformM3"));
        qeformM3->setGeometry(QRect(350, 38, 163, 187));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        qeformM1->setProperty("uiFile", QVariant(QApplication::translate("MainWindow", "/afs/slac/g/testfac/tools/display/beckhoff.1/common/ui/motormovepot.ui", 0)));
        qeformM1->setProperty("variableSubstitutions", QVariant(QApplication::translate("MainWindow", "P=$(P),M=$(M1),N=$(N),A=$(A1),C=1", 0)));
        qeformM2->setProperty("uiFile", QVariant(QApplication::translate("MainWindow", "/afs/slac/g/testfac/tools/display/beckhoff.1/common/ui/motormovepot.ui", 0)));
        qeformM2->setProperty("variableSubstitutions", QVariant(QApplication::translate("MainWindow", "P=$(P),M=$(M2),N=$(N),A=$(A1),C=2", 0)));
        qeformM3->setProperty("uiFile", QVariant(QApplication::translate("MainWindow", "/afs/slac/g/testfac/tools/display/beckhoff.1/common/ui/motormovepot.ui", 0)));
        qeformM3->setProperty("variableSubstitutions", QVariant(QApplication::translate("MainWindow", "P=$(P),M=$(M3),N=$(N),A=$(A2),C=1", 0)));
