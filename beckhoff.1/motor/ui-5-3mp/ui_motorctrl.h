...
public:
    ...
    void setupUi(QDialog *MotorCtrl)
    {
        ...
        qeform->setGeometry(QRect(4, 4, 497, 307));
        ...
        qeform_3->setGeometry(QRect(6, 6, 495, 314));
        ...
        qeform_5->setGeometry(QRect(6, 6, 493, 314));
        ...
        qeform_7->setGeometry(QRect(6, 6, 493, 314));
        ...
        qeform_9->setGeometry(QRect(6, 6, 495, 314));
        ...
        qeform_11->setGeometry(QRect(6, 6, 493, 314));
        ...
        ctrlClosePB->setGeometry(QRect(462, 6, 56, 24));
    ...
    void retranslateUi(QDialog *MotorCtrl)
    {
        ...
        qeform_2->setProperty("uiFile", QVariant(QApplication::translate("MotorCtrl", "/afs/slac/g/testfac/tools/display/beckhoff.1/common/ui/home.ui", 0)));
        ...
        qeform->setProperty("uiFile", QVariant(QApplication::translate("MotorCtrl", "/afs/slac/g/testfac/tools/display/beckhoff.1/common/ui/control.ui", 0)));
        ...
        qeform_3->setProperty("uiFile", QVariant(QApplication::translate("MotorCtrl", "/afs/slac/g/testfac/tools/display/beckhoff.1/common/ui/csr.ui", 0)));
        ...
        qeform_5->setProperty("uiFile", QVariant(QApplication::translate("MotorCtrl", "/afs/slac/g/testfac/tools/display/beckhoff.1/common/ui/readreg.ui", 0)));
        ...
        qeform_7->setProperty("uiFile", QVariant(QApplication::translate("MotorCtrl", "/afs/slac/g/testfac/tools/display/beckhoff.1/common/ui/writeram.ui", 0)));
        ...
        qeform_9->setProperty("uiFile", QVariant(QApplication::translate("MotorCtrl", "/afs/slac/g/testfac/tools/display/beckhoff.1/common/ui/writeeep.ui", 0)));
        ...
        qeform_11->setProperty("uiFile", QVariant(QApplication::translate("MotorCtrl", "/afs/slac/g/testfac/tools/display/beckhoff.1/common/ui/feature.ui", 0)));
