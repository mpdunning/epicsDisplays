 ...
 *---------------------------------------------------------------------------*/
  ...
  QString macro123,pmac,nmac,a1mac,a2mac,d1mac,d2mac,m1mac,m2mac,m3mac;
  _haveM=0;
  if(pm){
    macro.append(pm);
    _haveM=1;
    ...
    for( i=0; i<mlist.size(); i++){
      ...
      if(str.contains("A1=")) a1mac.append(str);
      if(str.contains("A2=")) a2mac.append(str);
      if(str.contains("D1=")) d1mac.append(str);
      if(str.contains("D2=")) d2mac.append(str);
    ...
    pmac.append("P=CHA");
    nmac.append("N=3m");
    a1mac.append("A1=3132-1");
    a2mac.append("A2=3132-2");
    d1mac.append("D1=4132-1");
    d2mac.append("D2=4132-2");
    m1mac.append("M1=2531-1");
    m2mac.append("M2=2531-2");
    m3mac.append("M3=2531-3");
  }
  ContainerProfile prof;
  _m1c=_m2c=_m3c=0; _bkh=0;
  ui=new Ui::MainWindow;
  _mac123.append(pmac).append(",").append(m1mac).append(",");
  _mac123.append(m2mac).append(",").append(m3mac).append(",");
  _mac123.append(a1mac).append(",").append(a2mac).append(",");
  _mac123.append(d1mac).append(",").append(d2mac).append(",").append(nmac);
