...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        qelError->setGeometry(QRect(184, 6, 56, 20));
        ...
        cashape->setGeometry(QRect(182, 4, 60, 24));
        ...
        menubar->setGeometry(QRect(0, 0, 342, 20));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        qeformM1->setProperty("variableSubstitutions", QVariant(QApplication::translate("MainWindow", "M=$(M1),A=$(A1),C=1", 0)));
        ...
        qeformM2->setProperty("variableSubstitutions", QVariant(QApplication::translate("MainWindow", "M=$(M2),A=$(A1),C=2", 0)));
