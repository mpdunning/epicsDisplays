...
public:
    ...
    void setupUi(QDialog *BkhDebug)
    {
        ...
        caplot_2 = new CAPlot(groupBox_2);
        caplot_2->setObjectName(QStringLiteral("caplot_2"));
        caplot_2->setGeometry(QRect(148, 26, 179, 145));
        caplot_2->setAutoScaleX(false);
        caplot_2->setProperty("gridEnableMajorX", QVariant(true));
        caplot_2->setXMax(50);
        caplot_2->setNTicksMajorX(5);
        caplot_2->setNTicksMinorX(1);
        caplot_2->setProperty("gridEnableMajorY", QVariant(true));
        caplot_2->setNTicksMajorY(7);
        caplot_2->setNTicksMinorY(0);
        caplot_2->setProperty("backgroundColor", QVariant(QColor(60, 60, 100)));
        caplot_2->setTrace2On(false);
        caplot_2->setTrace3On(false);
        caplot_2->setTrace4On(false);
        caplot_2->setTraceColor1(QColor(255, 240, 170));
    ...
    void retranslateUi(QDialog *BkhDebug)
    {
        ...
        caplot_2->setProperty("variable1", QVariant(QApplication::translate("BkhDebug", "$(P):WF:DEBUG-$(N):TIME:HIST", 0)));
        caplot_2->setProperty("variableSubstitutions", QVariant(QApplication::translate("BkhDebug", "P=CHA,N=2", 0)));
    } // retranslateUi
