...
public:
    ...
    void retranslateUi(QDialog *BkhDetail)
    {
        ...
        adcDac1QEF->setProperty("uiFile", QVariant(QApplication::translate("BkhDetail", "/afs/slac/g/testfac/tools/display/beckhoff/common/ui/adcdac2ch.ui", 0)));
        adcDac1QEF->setProperty("variableSubstitutions", QVariant(QApplication::translate("BkhDetail", "P=$(P),R=$(A1),T=$(D1),N=$(N)", 0)));
        tabWidget->setTabText(tabWidget->indexOf(adc1), QApplication::translate("BkhDetail", "ADC1-DAC1", 0));
        adcDac2QEF->setProperty("uiFile", QVariant(QApplication::translate("BkhDetail", "/afs/slac/g/testfac/tools/display/beckhoff/common/ui/adcdac2ch.ui", 0)));
        ...
        qeform_22->setProperty("uiFile", QVariant(QApplication::translate("BkhDetail", "/afs/slac/g/testfac/tools/display/beckhoff/common/ui/hidden.ui", 0)));
        ...
        qeform_18->setProperty("uiFile", QVariant(QApplication::translate("BkhDetail", "/afs/slac/g/testfac/tools/display/beckhoff//common/ui/hidden.ui", 0)));
        ...
        qeform_19->setProperty("uiFile", QVariant(QApplication::translate("BkhDetail", "/afs/slac/g/testfac/tools/display/beckhoff//common/ui/hidden.ui", 0)));
