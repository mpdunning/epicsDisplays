...
/*
  ...
  _macadc.append(pmac).append(",").append(amac).append(",").append(nmac);
  _macadc=_macadc.replace("A1","R");
*/
_macadc=prof.getMacroSubstitutions();
qDebug()<<"BkhDetail: macros="<<_macros;
qDebug()<<"BkhDetail: macadc="<<_macadc;
  ui=new Ui::BkhDetail;
