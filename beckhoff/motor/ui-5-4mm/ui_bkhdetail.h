...
public:
    ...
    void setupUi(QDialog *BkhDetail)
    {
        ...
        adcDac1QEF->setGeometry(QRect(14, 14, 441, 333));
    ...
    void retranslateUi(QDialog *BkhDetail)
    {
        ...
        adcDac1QEF->setProperty("uiFile", QVariant(QApplication::translate("BkhDetail", "/afs/slac/g/testfac/tools/display/beckhoff/common/ui/adcdac4ch.ui", 0)));
        adcDac1QEF->setProperty("variableSubstitutions", QVariant(QApplication::translate("BkhDetail", "P=$(P),C1=$(C1),R=$(A1),T=$(D1),N=$(N),C2=$(C2),C3=$(C3),C4=$(C4)", 0)));
