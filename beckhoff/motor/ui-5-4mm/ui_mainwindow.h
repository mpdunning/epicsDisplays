...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        groupBox->setGeometry(QRect(4, 36, 340, 220));
        ...
        groupBox_2->setGeometry(QRect(352, 36, 340, 220));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        qeform1->setProperty("uiFile", QVariant(QApplication::translate("MainWindow", "/afs/slac/g/testfac/tools/display/beckhoff/common/ui/motormovepot.ui", 0)));
        qeform1->setProperty("variableSubstitutions", QVariant(QApplication::translate("MainWindow", "P=$(P),M=$(M1),N=$(N),R=$(A1),C=$(C1)", 0)));
        qeform2->setProperty("uiFile", QVariant(QApplication::translate("MainWindow", "/afs/slac/g/testfac/tools/display/beckhoff/common/ui/motormovepot.ui", 0)));
        qeform2->setProperty("variableSubstitutions", QVariant(QApplication::translate("MainWindow", "P=$(P),M=$(M2),N=$(N),R=$(A1),C=$(C2)", 0)));
        groupBox_2->setTitle(QApplication::translate("MainWindow", "ESTB Vertical Colimator", 0));
        qeform3->setProperty("uiFile", QVariant(QApplication::translate("MainWindow", "/afs/slac/g/testfac/tools/display/beckhoff/common/ui/motormovepot.ui", 0)));
        qeform3->setProperty("variableSubstitutions", QVariant(QApplication::translate("MainWindow", "P=$(P),M=$(M3),N=$(N),R=$(A1),C=$(C3)", 0)));
        qeform4->setProperty("uiFile", QVariant(QApplication::translate("MainWindow", "/afs/slac/g/testfac/tools/display/beckhoff/common/ui/motormovepot.ui", 0)));
        qeform4->setProperty("variableSubstitutions", QVariant(QApplication::translate("MainWindow", "P=$(P),M=$(M4),N=$(N),R=$(A1),C=$(C4)", 0)));
