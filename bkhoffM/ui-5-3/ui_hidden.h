...
public:
    ...
    void retranslateUi(QDialog *Hidden)
    {
        ...
        qeform->setProperty("uiFile", QVariant(QApplication::translate("Hidden", "hiddenreg.ui", 0)));
        qeform->setProperty("variableSubstitutions", QVariant(QApplication::translate("Hidden", "Q=2531-1,N=2", 0)));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("Hidden", "Mot 1", 0));
        qeform_2->setProperty("uiFile", QVariant(QApplication::translate("Hidden", "hiddenreg.ui", 0)));
        qeform_2->setProperty("variableSubstitutions", QVariant(QApplication::translate("Hidden", "Q=2531-2,N=2", 0)));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("Hidden", "Mot 2", 0));
        qeform_3->setProperty("uiFile", QVariant(QApplication::translate("Hidden", "hiddenreg.ui", 0)));
        qeform_3->setProperty("variableSubstitutions", QVariant(QApplication::translate("Hidden", "Q=3132,N=2", 0)));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("Hidden", "ADC", 0));
        qeform_4->setProperty("uiFile", QVariant(QApplication::translate("Hidden", "hiddenreg.ui", 0)));
        qeform_4->setProperty("variableSubstitutions", QVariant(QApplication::translate("Hidden", "Q=4132,N=2", 0)));
